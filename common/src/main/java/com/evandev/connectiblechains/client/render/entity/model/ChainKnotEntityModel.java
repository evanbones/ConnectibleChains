...
public class ChainKnotEntityModel extends EntityModel<ChainKnotEntityRenderState> {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        knot.addOrReplaceChild("east_r1", CubeListBuilder.create().texOffs(-4, 8).mirror().addBox(-2.5F, 0.0F, -3.0F, 4.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(-3.0F, -0.5F, 0.0F, -3.1416F, 0.0F, -1.5708F));
